...
- [cmd/compile: mis-calculates a constant](https://github.com/golang/go/issues/11369)
...
- [fmt: index out of range (6)](https://github.com/golang/go/issues/11376)
...
- [go/format: adds }](https://github.com/golang/go/issues/11276)
